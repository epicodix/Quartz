---
title: 1. 쿠버네티스의 유래와 핵심 철학
summary: 쿠버네티스를 '컨테이너를 관리하는 도구'라고만 알고 있다면, 수많은 개념 앞에서 길을 잃기 쉽습니다. 쿠버네티스를 제대로 이해하려면,
  이 도구가 어떤 고민 끝에 탄생했고, 어떤 철학을 기반으로 움직이는지 먼저 알아야 합니다.
tags:
- 미분류
category: 기타
difficulty: 중급
