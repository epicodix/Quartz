---
title: OSI 7계층 모델의 이해와 쿠버네티스(Kubernetes) 적용
summary: OSI 7계층 모델의 각 역할을 집 짓기에 비유하여 쉽게 설명하고, 특히 L3(Network), L4(Transport), L7(Application)
  계층이 쿠버네티스 환경에서 Calico, Service, Cilium 등을 통해 어떻게 적용되는지 실용적인 예시와 함께 분석합니다.
tags:
- OSI 7계층
- Kubernetes
- 네트워킹
