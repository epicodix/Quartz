---
title: k8s-gemini 'MOC' note
summary: 네, 마침 '클라우드 네이티브' 부트캠프를 듣고 계시니 쿠버네티스는 가장 핵심적인 주제이겠네요. 오늘 스터디에서 다루신 API 서버와
  Kubelet의 상호작용을 중심으로, 옵시디언(Obsidian)에서 관리하기 좋은 '연결된 노트(Connected Notes)' 방식으...
tags:
- 미분류
category: 기타
difficulty: 중급
