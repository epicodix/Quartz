...
## 📚 목차
1. [파드 레이블 (Label)](#1.-파드-레이블-label)
2. [정적(Static) 파드](#2.-정적static-파드)
3. [컨테이너 상태에 따른 동작 (restartPolicy)](#3.-컨테이너-상태에-따른-동작-restartpolicy)
4. [애플리케이션 상태 탐사 (Probes)](#4.-애플리케이션-상태-탐사-probes)
