...
> [!info] 통합 가이드
> 이 문서는 학습 로드맵, 패턴 선택 가이드, 기술 스택 추천, 체크리스트를 모두 포함한 통합 실전 가이드입니다.
...
**3. 2026 추천 아키텍처 스택**
- 소규모/중규모/대규모 기업별 기술 스택
- 통신/데이터/복원력/배포/보안 레이어 구성
- 현대적인 MSA 도구 선택
...
**관련 패턴**:
- [[../02-데이터-관리-패턴/Event-Sourcing-패턴|Event Sourcing]]
- [[../02-데이터-관리-패턴/CQRS-패턴|CQRS]]
- [[../05-보안-거버넌스-패턴/Zero-Trust-Architecture|Zero Trust]]
...
1. **프로젝트별 적용 전략** 확인 ([[#🗺️ 프로젝트별 적용 전략|바로가기]])
2. **점진적 도입 전략** 수립 ([[#📊 점진적 도입 전략|바로가기]])
3. **패턴 조합 레시피** 참고 ([[#🔗 패턴 조합 레시피|바로가기]])
4. **최종 체크리스트** 점검 ([[#📋 최종 체크리스트|바로가기]])
