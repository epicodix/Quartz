---
title: '아키텍처 진화의 3단계: 온프레미스 K8s에서 GKE, 그리고 Cloud Run까지'
summary: 온프레미스(On-premise) 환경에서 운영하던 쿠버네티스(K8s)를 구글 쿠버네티스 엔진(GKE)으로 옮기고, 나아가 서버리스(Serverless)
  플랫폼인 클라우드 런(Cloud Run)으로 전환하는 과정은 현대적인 클라우드 네이티브 아키텍처의 이상적인 진화 경로...
tags:
- 미분류
category: 기술분석
difficulty: 중급
