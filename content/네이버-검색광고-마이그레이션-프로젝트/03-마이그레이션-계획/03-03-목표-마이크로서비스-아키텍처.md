---
title: 모놀리식 구조의 마이크로서비스 분해 전략 및 설계
summary: 기존의 모놀리식 Apps Script 구조를 도메인 기반의 마이크로서비스 아키텍처로 전환하는 전략을 제시합니다. API Gateway를
  중심으로 인증, 데이터 수집 등 각 서비스의 책임과 Python 기반의 상세 설계 예시를 포함합니다.
tags:
- 마이크로서비스
- 아키텍처
- 리팩토링
